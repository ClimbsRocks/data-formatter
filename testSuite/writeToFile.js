...
// each of the relevant files should be the right length
// it should include a header row if possible (depending how we binarize, i'm not sure if this will be possible or not)
// it should probably format the data in a nice, generalized way (utf8, etc.)
